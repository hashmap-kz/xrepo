...
func repoTestsCreateS3Client(t *testing.T) (*s3.Client, storage.Storage) {
	t.Helper()
	return createS3Client("repo-unittest")
}

func TestRepoS3_PutAndGet_GzipV1(t *testing.T) {
	_, stor := repoTestsCreateS3Client(t)
...
func TestRepoS3_PutAndGet_NoCompression_NoEncryption(t *testing.T) {
	_, stor := repoTestsCreateS3Client(t)
...
func TestRepoS3_PutAndGet_GzipV2(t *testing.T) {
	_, stor := repoTestsCreateS3Client(t)
...
func TestRepoS3_PutAndGet_EncryptionOnly(t *testing.T) {
	_, stor := repoTestsCreateS3Client(t)
...
func TestRepoS3_PutAndGet_GzipAndEncryption(t *testing.T) {
	_, stor := repoTestsCreateS3Client(t)
...
func TestRepoS3_EmptyFile(t *testing.T) {
	_, stor := repoTestsCreateS3Client(t)
	r := repo.NewWriteReader(stor, &codec.GzipCompressor{}, nil)
